...
void FFP_Modulate(in vec3, in vec3, out vec3);
...
void main(void) {
	...
	SGX_ComputeShadowFactor_PSSM3(oTexcoord1_2, pssm_split_points0, oTexcoord4_3, oTexcoord4_4, oTexcoord4_5, shadow_map1, shadow_map2, shadow_map3, inv_shadow_texture_size1, inv_shadow_texture_size2, inv_shadow_texture_size3, lShadowFactor);
	...
	FFP_Modulate(source1.xyz, source2.xyz, fragColour.xyz);
